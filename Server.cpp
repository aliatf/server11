...
DWORD WINAPI Server::ToClient(LPVOID client_socket)
{
	...
	/*дальше идут сообщения которые подсказывают клиенту что делать*/
...
#define no_data "nothing to sort, first use command SEND то add info to DB\r\n"
